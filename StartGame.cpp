...
{
	BG = loadTexture("images/snakefake.png", ren);
...
void StartGame::mainMenu(SDL_Renderer* renderer)
{
	...
	/*createText("New Game", renderer, 140, 200, 150, 80, green);
	createText("Quit Game", renderer, 140, 300, 150, 80, green);*/
	...
	while (!isQuit)
	{
		...
		while (SDL_PollEvent(&e) != 0)
		{
			...
			if (e.type == SDL_MOUSEMOTION)
			{
				...
				//else createText("New Game", renderer, 140, 200, 150, 80, green);

				if (x > 140 && x < 290 && y < 400 && y>300) createText("Quit Game", renderer, 140, 300, 150, 80, yellow);
				//else createText("Quit Game", renderer, 140, 300, 150, 80, green);
